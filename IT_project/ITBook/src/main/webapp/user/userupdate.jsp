									...
									<td colspan="2">
										<form action="${pageContext.request.contextPath}/Updateuser"
											...
											<table align="center" style="border-collapse:separate; border-spacing:0px 10px">
													...
													<td width="5%">&nbsp;</td>
													<td style="color: white; font-weight:400">用户编号:</td>

													<td width="55%"><input class="form-control"
												...
												<tr>
													...
													<td width=55%><input class="form-control" type="text"
														name="uname" value="${user.uname}" /></td>
												...
												<tr>
													...
													<td width=55%><input class="form-control" type="text"
														name="upwd" value="${user.password}" /></td>
												...
												<tr>
													...
													<td width=55%><input class="form-control" type="text"
														name="uaddr" value="${user.uaddress}" /></td>
												...
												<tr>
													...
													<td width=55%><input class="form-control" type="text"
														name="ugrade" value="${user.ugrade}" /></td>
										
												</tr>
												
												<tr>
													<td colspan="3" align="right"><input class="btn btn-primary"
														type="submit" value="修改" />
											
													<a href="${pageContext.request.contextPath}/Jmppage">
													<input style="margin-left:32px;" class="btn btn-primary" type="button" value="返回" />
													</a>
													</td>
												...
												<tr>
												    ...
												    <span style="color: red; font-weight: 400"><c:if
														  test="${flag==true}">无输入或格式错误，请重新输入！</c:if></span>
													</div><!--如果接收到格式错误信息，则输出错误提示-->
												<tr>
											</table>
										</form>
									</td>
